...
@section('title', 'Upravit kontakt - CRM System')
...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Upravit kontakt</h1>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">{{ $contact->first_name }} {{ $contact->last_name }}</p>
        </div>
